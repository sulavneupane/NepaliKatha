 ...
 */
public class RecyclerViewPoemsAdapter extends RecyclerView.Adapter<RecyclerViewPoemsAdapter.PoemViewHolder> {
    DatabaseHandler handler;
    private Context context;
    private List<Poem> poems;

    public RecyclerViewPoemsAdapter(Context context, List<Poem> poems) {
        this.context = context;
        this.poems = poems;
    }

    @Override
    public RecyclerViewPoemsAdapter.PoemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(context).inflate(R.layout.single_story_style, parent, false);
        RecyclerViewPoemsAdapter.PoemViewHolder holder = new PoemViewHolder(view);

        return holder;
    }

    @Override
    public void onBindViewHolder(final RecyclerViewPoemsAdapter.PoemViewHolder holder, final int position) {
