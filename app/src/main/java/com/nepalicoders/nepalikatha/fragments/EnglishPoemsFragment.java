 ...
 */
public class EnglishPoemsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_english_stories, container, false);

        recyclerView = (RecyclerView) view.findViewById(R.id.english_poems_list);
    ...
    public void onResume() {
        ...
        Cursor cursor = handler.getAllEnglishPoemsFromDatabase();
        if (cursor != null && cursor.getCount() > 0) {
            ...
            Messages.snackBarShort(view, getString(R.string.no_english_poems));
